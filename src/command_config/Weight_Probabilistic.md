CUDA_VISIBLE_DEVICES=1 python main.py \
    --run_name Weight-Diffusion-Probabilistic-v5 \
    ...
    --resume /zhome/66/4/156534/Master_Thesis/src/train_results/Weight-Diffusion-Probabilistic-v4/weights/weights.pt
