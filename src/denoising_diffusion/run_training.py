...
from src.denoising_diffusion.train import train
...
def parse_args():
    ...
    parser.add_argument("--weights_dir", type=str, default="src/denoising_diffusion/weights", help="Where to save model weights")
    parser.add_argument("--graphs_dir", type=str, default="src/denoising_diffusion/graphs", help="Where to save loss plot")
    parser.add_argument("--results_dir", type=str, default="src/denoising_diffusion/results", help="Where to save sampled images")
