...
Example usage:
    python src/denoising_diffusion/inference.py --Master_Thesis/src/denoising_diffusion/weights/ddpm_mnist_epoch030.pt
    python src/denoising_diffusion/inference.py --weights src/denoising_diffusion/weights/ddpm_mnist_epoch010.pt
    --out_path src/denoising_diffusion/results/sample_grid.png
"""
...
from src.denoising_diffusion.model import Diffusion, UNet
