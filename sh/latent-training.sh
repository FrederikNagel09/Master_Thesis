#!/bin/bash
#BSUB -J latent-diffusion-ramp      # Job name
...
#BSUB -o src/outputs/latent-diffusion-ramp.out                        # Standard output redirection
#BSUB -e src/outputs/latent-diffusion-ramp.err                        # Standard error redirection
#BSUB -N                                   # send email when job finishes
#BSUB -B                                   # Send email when job begins

# Activate virtual environment
# bsub < sh/latent-training.sh
source /zhome/66/4/156534/Master_Thesis/.venv/bin/activate

# --- Phase 1+2+3: Training ---
python /zhome/66/4/156534/Master_Thesis/main.py\
    --run_name latent-diffusion-ramp \
    --epochs 450 \
    --batch_size 128 \
    --subset_frac 1.0 \
    --n_fid_samples 4096 \
