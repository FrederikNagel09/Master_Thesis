#!/bin/bash
#BSUB -J latent-diffusion-VOXEL      # Job name
...
#BSUB -o src/outputs/latent-diffusion-VOXEL.out                        # Standard output redirection
#BSUB -e src/outputs/latent-diffusion-VOXEL.err                        # Standard error redirection
