#!/bin/bash
#BSUB -J latent-diffusion      # Job name
...
#BSUB -o src/outputs/latent-diffusion.out                        # Standard output redirection
#BSUB -e src/outputs/latent-diffusion.err                        # Standard error redirection
