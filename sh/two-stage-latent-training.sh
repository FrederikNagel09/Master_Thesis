#!/bin/bash
#BSUB -J VOXEL-Latent-Fixed-TEST      # Job name
...
#BSUB -o src/outputs/VOXEL-Latent-Fixed-TEST.out                        # Standard output redirection
#BSUB -e src/outputs/VOXEL-Latent-Fixed-TEST.err                        # Standard error redirection
