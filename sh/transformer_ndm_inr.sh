#!/bin/bash
#BSUB -J Latent-Diffusion-Probabilistic-test-detach      # Job name
...
#BSUB -o src/outputs/Latent-Diffusion-Probabilistic-test-detach.out                        # Standard output redirection
#BSUB -e src/outputs/Latent-Diffusion-Probabilistic-test-detach.err                        # Standard error redirection
