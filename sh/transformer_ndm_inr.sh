#!/bin/bash
#BSUB -J Latent-Diffusion-Probabilistic-test-detach-twostage      # Job name
...
#BSUB -o src/outputs/Latent-Diffusion-Probabilistic-test-detach-twostage.out                        # Standard output redirection
#BSUB -e src/outputs/Latent-Diffusion-Probabilistic-test-detach-twostage.err                        # Standard error redirection
...
python /zhome/66/4/156534/Master_Thesis/main.py\
    --run_name Latent-Diffusion-Probabilistic-test-detach-twostage \
