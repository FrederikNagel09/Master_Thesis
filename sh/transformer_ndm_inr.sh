#!/bin/bash
#BSUB -J latent_inr_diffusion_probablistic_annealing_bigger           # Job name
...
#BSUB -o src/outputs/latent_inr_diffusion_probablistic_annealing_bigger.out                        # Standard output redirection
#BSUB -e src/outputs/latent_inr_diffusion_probablistic_annealing_bigger.err                        # Standard error redirection
...
python /zhome/66/4/156534/Master_Thesis/main.py\
    --run_name latent_inr_diffusion_probablistic_annealing_bigger \
