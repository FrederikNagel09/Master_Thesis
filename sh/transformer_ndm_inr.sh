#!/bin/bash
#BSUB -J TransNdmInr_temporal_v1            # Job name
...
#BSUB -o src/outputs/TransNdmInr_temporal_v1.out                        # Standard output redirection
#BSUB -e src/outputs/TransNdmInr_temporal_v1.err                        # Standard error redirection
