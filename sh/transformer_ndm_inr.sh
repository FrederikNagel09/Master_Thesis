#!/bin/bash
#BSUB -J trans-trans-WeightSpace-inr           # Job name
...
#BSUB -o src/outputs/trans-trans-WeightSpace-inr.out                        # Standard output redirection
#BSUB -e src/outputs/trans-trans-WeightSpace-inr.err                        # Standard error redirection
...
python /zhome/66/4/156534/Master_Thesis/main.py\
    --run_name trans-trans-WeightSpace-inr\
