#!/bin/bash
#BSUB -J TransNdmInr_0.2data_GlobalNorm              # Job name
...
#BSUB -o src/outputs/TransNdmInr_0.2data_GlobalNorm.out                        # Standard output redirection
#BSUB -e src/outputs/TransNdmInr_0.2data_GlobalNorm.err                        # Standard error redirection
...
python /zhome/66/4/156534/Master_Thesis/main.py \
    --run_name TransNdmInr_0.2data_GlobalNorm \
