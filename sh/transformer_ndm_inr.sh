#!/bin/bash
#BSUB -J TransNdmInr_0_2data_regularize            # Job name
...
#BSUB -o src/outputs/TransNdmInr_0_2data_regularize.out                        # Standard output redirection
#BSUB -e src/outputs/TransNdmInr_0_2data_regularize.err                        # Standard error redirection
...
python /zhome/66/4/156534/Master_Thesis/main.py \
    --run_name TransNdmInr_0_2data_regularize \
