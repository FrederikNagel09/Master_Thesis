#!/bin/bash
#BSUB -J Latent-Diffusion-Probabilistic-twostageTest      # Job name
...
#BSUB -o src/outputs/Latent-Diffusion-Probabilistic-twostageTest.out                        # Standard output redirection
#BSUB -e src/outputs/Latent-Diffusion-Probabilistic-twostageTest.err                        # Standard error redirection
