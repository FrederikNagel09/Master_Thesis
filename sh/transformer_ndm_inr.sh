#!/bin/bash
#BSUB -J trans-trans-ndm-inr           # Job name
...
#BSUB -o src/outputs/trans-trans-ndm-inr.out                        # Standard output redirection
#BSUB -e src/outputs/trans-trans-ndm-inr.err                        # Standard error redirection
