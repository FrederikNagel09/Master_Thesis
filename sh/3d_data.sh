#!/bin/bash
#BSUB -J latent-probability-3D-data      # Job name
...
#BSUB -o src/outputs/latent-probability-3D-data.out                        # Standard output redirection
#BSUB -e src/outputs/latent-probability-3D-data.err                        # Standard error redirection
