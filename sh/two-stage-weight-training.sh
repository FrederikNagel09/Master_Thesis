#!/bin/bash
#BSUB -J VOXEL-Weight-Converge-TEST     # Job name
...
#BSUB -o src/outputs/VOXEL-Weight-Converge-TEST.out                        # Standard output redirection
#BSUB -e src/outputs/VOXEL-Weight-Converge-TEST.err                        # Standard error redirection
