#!/bin/bash
#BSUB -J weight_two_stage_fixed      # Job name
...
#BSUB -o src/outputs/weight_two_stage_fixed.out                        # Standard output redirection
#BSUB -e src/outputs/weight_two_stage_fixed.err                        # Standard error redirection
...
python /zhome/66/4/156534/Master_Thesis/src/scripts/two-stage-weight-training.py\
    --run_name weight_two_stage_fixed \
    --mode fixed \
