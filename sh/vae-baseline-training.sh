#!/bin/bash
#BSUB -J vae_3d_baseline_0.000001           # Job name
...
#BSUB -o src/outputs/vae_3d_baseline_0.000001.out                        # Standard output redirection
#BSUB -e src/outputs/vae_3d_baseline_0.000001.err                        # Standard error redirection
...
python /zhome/66/4/156534/Master_Thesis/src/scripts/VAE_Baseline_Training_3D.py \
    --run_name vae_3d_baseline_0.000001 \
