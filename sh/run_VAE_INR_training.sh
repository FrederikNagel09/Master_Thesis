#!/bin/bash
#BSUB -J vae_inr_mnist_mod                    # Job name
...
#BSUB -o src/outputs/vae_inr_mnist_mod.out                        # Standard output redirection
#BSUB -e src/outputs/vae_inr_mnist_mod.err                        # Standard error redirection
