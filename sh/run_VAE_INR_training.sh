#!/bin/bash
#BSUB -J vae-inr-cifar10-a100                    # Job name
#BSUB -q gpua100                            # Queue to submit the job to
#BSUB -W 1800                              # Wall time limit (6 hours)
#BSUB -n 4                                 # Request 4 cores
#BSUB -R "rusage[mem=1GB]"                 # Request 1 GB of memory per core
#BSUB -R "span[hosts=1]"                   # Request all cores on the same host
#BSUB -gpu "num=1:mode=exclusive_process"  # Request 1 GPU in exclusive mode
#BSUB -o src/outputs/vae-inr-cifar10-a100.out                        # Standard output redirection
#BSUB -e src/outputs/vae-inr-cifar10-a100.err                        # Standard error redirection
...
python /zhome/66/4/156534/Master_Thesis/src/scripts/VAE_Baseline_Training.py \
    --run_name vae-inr-cifar10-a100-big \
    --dataset cifar10 \
    --epochs 1000 \
    --batch_size 128 \
    --lr 1e-4 \
