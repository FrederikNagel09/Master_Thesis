#!/bin/bash
#BSUB -J final_eval_weight_fixed                       # Job name
...
#BSUB -o src/outputs/final_eval_weight_fixed.out                        # Standard output redirection
#BSUB -e src/outputs/final_eval_weight_fixed.err                        # Standard error redirection
#BSUB -N                                   # send email when job finishes
#BSUB -B                                   # Send email when job begins

# Activate virtual environment
# bsub < sh/final_evals/w_fix.sh
