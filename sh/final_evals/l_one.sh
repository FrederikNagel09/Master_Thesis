#!/bin/bash
#BSUB -J final_eval_latent_one_stage                       # Job name
...
#BSUB -o src/outputs/final_eval_latent_one_stage.out                        # Standard output redirection
#BSUB -e src/outputs/final_eval_latent_one_stage.err                        # Standard error redirection
#BSUB -N                                   # send email when job finishes
#BSUB -B                                   # Send email when job begins

# Activate virtual environment
# bsub < sh/final_evals/l_one.sh
